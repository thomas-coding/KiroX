  ...
  var DICT = {
    zh: {
      ...
      register: {
        ...
        emailProvider: '邮箱提供商', outlook: '微软邮箱', moemail: 'MoeMail', cloudmail: 'Cloud-Mail', mailmanager: 'Mail Manager', smsbGmail: 'SMSB Gmail',
        ...
        smsbGmailHint: '使用 SMSB AWS Gmail 临时邮箱并自动等待 Kiro 验证码。',
    ...
    en: {
      ...
      register: {
        ...
        emailProvider: 'Email provider', outlook: 'Microsoft', moemail: 'MoeMail', cloudmail: 'Cloud-Mail', mailmanager: 'Mail Manager', smsbGmail: 'SMSB Gmail',
        ...
        smsbGmailHint: 'Use SMSB AWS Gmail temporary mailboxes and wait for Kiro OTP automatically.',
    ...
    ja: {
      ...
      register: {
        ...
        emailProvider: 'メールプロバイダ', outlook: 'Microsoft', moemail: 'MoeMail', cloudmail: 'Cloud-Mail', mailmanager: 'Mail Manager', smsbGmail: 'SMSB Gmail',
        ...
        smsbGmailHint: 'SMSB AWS Gmail の一時メールで Kiro の認証コードを自動取得します。',
